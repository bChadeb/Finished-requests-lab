...
const repeatMyParam = () => {
    axios.get(`http://localhost:3000/repeat/${"Yomama"}`)
    .then((res) => {
...
function queryTest() {
    axios.get(`http://localhost:3000/query-test/?Yo=mama`)
    .then((res) => {
        console.log(res.data)
    })
}
...
/*
    ...
    // it console.log the following message "You sent an empty query!"

    2: Send more than 1 query on the URL -- what happened? 

    // it prints out "You sent more than 1 query!"
